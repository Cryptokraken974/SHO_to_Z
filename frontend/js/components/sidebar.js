            ...
            <div class="accordion-section mb-6">
                ...
                <div class="accordion-content bg-[#262626] rounded-lg mt-2 p-3" id="get-data-content">
                    <div class="space-y-3">
                        ...
                        <button id="test-sentinel2-btn" class="w-full bg-[#dc3545] hover:bg-[#c82333] text-white px-4 py-3 rounded-lg font-medium transition-colors mt-2">🛰️ Get Sentinel-2 Images</button>
