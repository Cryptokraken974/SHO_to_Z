 ...
 * Header Component
 */
window.componentManager.register('header', (props = {}) => {
    const { title = 'LAZ Terrain Processor', showHelp = true } = props;
    ...
    return `
        <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#303030] px-10 py-3">
            <div class="flex items-center gap-4 text-white">
                ...
                <h2 class="text-white text-lg font-bold leading-tight tracking-[-0.015em]">${title}</h2>
            </div>
            ${showHelp ? `
