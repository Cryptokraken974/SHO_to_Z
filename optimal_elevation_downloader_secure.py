...
"""
    ...
    def download_elevation_data(self, region_key: str, force_dataset: Optional[DatasetType] = None) -> Dict:
        ...
        for dataset in datasets_to_try:
            ...
            result = self._download_from_opentopography(region_key, bbox, dataset)
    ...
    def _download_from_opentopography(self, region_key: str, bbox: Dict, dataset: DatasetType) -> Dict:
        ...
        try:
            ...
            if response.status_code == 200 and response.headers.get('content-type', '').startswith('image/'):
                ...
                output_file = self.download_path / f"{region_key}_{dataset.value.lower()}_elevation.tif"
